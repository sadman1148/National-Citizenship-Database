...
<body>
    ...
    <h1>
		...
		<form action="add_c.php" class="form_design" method="post">
			Husband ID: <input type="text" name="nid"><br/><br/>
			Wife ID: <input type="text" name="name"><br/><br/>
            Marriage Date:  <input type="text" name="age"><br/><br/>
