...
<body>
    ...
    <h1>
        Edit a Wife or a Husband's relation.
    </h1>
		<form action="edit_c.php" class="form_design" method="post">
            ID: <input type="text" name="id"><br/><br/>
			Attribute: <input type="text" name="att"><br/><br/>
			New ID: <input type="text" name="info"><br/><br/>
            New Marriage Date: <input type="text" name="infoe"><br/><br/>
            ...
            border-style: dotted; 
            color: rgb(44, 178, 255);
            transition: all 0.3s ease-in-out;" type="submit" value="Change" class="but">
		</form>
</body>
</html>