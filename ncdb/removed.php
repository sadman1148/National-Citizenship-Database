...
<body>
    ...
    <h1>
		...
		<form action="remove_dist.php" class="form_design" method="post">
			Postal Code / Name of District for removal: <input type="text" name="info"><br/><br/>
            ...
            border-style: dotted; 
            color: rgb(44, 178, 255);
            transition: all 0.3s ease-in-out;" type="submit" value="Remove" class="but">
		</form>
