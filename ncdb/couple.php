...
<body>
    ...
    <button style="margin-left:39%;" class="but" onclick="window.location.href='addc.php';">Add Couple</button>
    <button class="but" onclick="window.location.href='removec.php';">Remove Couple</button>
    <button class="but" onclick="window.location.href='editc.php';">Edit Couple</button>
    <h1>
        Married Couples:
    </h1>
    <?php
    require_once("dbconnect.php");
    $sql = "SELECT c1.name,c2.name,md FROM spouse Inner Join citizens c1 INNER JOIN citizens c2 on spouse.hid=c1.id and spouse.wid=c2.id";
