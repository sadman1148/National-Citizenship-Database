...
<body>
    ...
    <button style="margin-left:42.5%;" class="but" onclick="window.location.href='addp.php';">Add Parents</button>
    <button class="but" onclick="window.location.href='removep.php';">Remove family</button>
    <h1>
        Families:
    </h1>
    <?php
    require_once("dbconnect.php");
    $sql = "SELECT c1.name,c2.name,c3.name FROM family Inner Join citizens c1 INNER JOIN citizens c2 inner join citizens c3 on family.child=c1.id and family.father=c2.id and family.mother=c3.id";
