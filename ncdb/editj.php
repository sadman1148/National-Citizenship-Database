...
<body>
    ...
    <h1>
		...
		<form action="edit_j.php" class="form_design" method="post">
            Designation: <input type="text" name="id"><br/><br/>
            Company Name: <input type="text" name="cn"><br/><br/>
			Attribute: <input type="text" name="att"><br/><br/>
			New Data: <input type="text" name="info"><br/><br/>
            ...
            border-style: dotted; 
            color: rgb(44, 178, 255);
            transition: all 0.3s ease-in-out;margin-left:45%" type="submit" value="Change" class="but">
		</form>
</body>
</html>