...
<body>
    ...
    <button style="margin-left:38%;" class="but" onclick="window.location.href='addv.php';">Add Vehicle</button>
    <button class="but" onclick="window.location.href='removev.php';">Remove Vehicle</button>
    <button class="but" onclick="window.location.href='editv.php';">Edit Vehicle</button>
    <h1>
        Vehicles owned by the citizens:
    </h1>
    <?php
