...
<head>
    ...
    <title>National Citizenship Database</title>
</head>
<style>
    ul{
        margin:0px;
...
<body>
    ...
    <h1>Welcome to the National Citizenship Database!</h1>
    <p>
        
        This database keeps track of all the citizens of Bangladesh.
        <br>
        <br>
        Note: This is a project database created to showcase what a
        real citizenship database looks like.
    </p>
    
    <button class="but" onclick="window.location.href='citizens.php';">Enter Database</button>
    
    <h6>
        Project Done under the supervision of: <a href="https://www.facebook.com/faisal.b.ashraf">FBA (sir)</a>
    </h6>
</body>
</html>