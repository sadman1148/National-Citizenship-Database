...
<body>
    ...
    <h1>
		...
		<form action="add_vehicle.php" class="form_design" method="post">
			Vehicle ID: <input type="text" name="nid"><br/><br/>
			Vehicle Company: <input type="text" name="name"><br/><br/>
            Owner ID: <input type="text" name="age"><br/><br/>
