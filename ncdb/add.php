...
<body>
    ...
    <h1>
		...
		<form action="add_citizen.php" class="form_design" method="post">
			ID: <input type="text" name="nid"><br/><br/>
			Name: <input type="text" name="name"><br/><br/>
            Age: <input type="text" name="age"><br/><br/>
            Date-of-Birth: <input type="text" name="dob"><br/><br/>
            Height: <input type="text" name="height"><br/><br/>
            Sex: <input type="text" name="sex"><br/><br/>
            Marital Status: <input type="text" name="ms"><br/><br/>
            Eye Color: <input type="text" name="ecolor"><br/><br/>
            Blood Group: <input type="text" name="bg"><br/><br/>
            Address: <input type="text" name="dname"><br/><br/>
            Job: <input type="text" name="jname"><br/><br/>
