...
<body>
    ...
    <button style="margin-left:41%;" class="but" onclick="window.location.href='addj.php';">Add Job</button>
    <button class="but" onclick="window.location.href='removej.php';">Remove Job</button>
    <button class="but" onclick="window.location.href='editj.php';">Edit Job</button>
    <h1>
        List of Jobs:
    </h1>
    <?php
    require_once("dbconnect.php");
    $sql = "SELECT * FROM jobs order by salary DESC";
